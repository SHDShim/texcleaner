...
At the boundary between hydrogen-rich envelopes and silicate-metal cores, pressures of tens of gigapascals and temperatures of several thousand kelvin enable hydrogen to react with rock-forming elements, potentially altering interior composition and density. 
...
Mg metal and Mg–Fe mixtures were used as starting materials for high-pressure synthesis.
...
We calculated the mass-radius relations of hypothetical single-material planet with Mg$_2$FeH$_6$, MgH$_2$, H$_2$O, and bridgmanite, as well as multi-layered planets composed of bridgmanite + H$_2$O, bridgmanite + Fe, MgO + Fe and Mg$_2$FeH$_6$ + H$_2$O. 
Profiles of mass ($m$), density ($\rho$), pressure ($P$), and gravity ($g$) as functions of radius are calculated following the approaches established in previous studies (e.g., \citeA{unterborn_pressure_2019, boujibar_superearth_2020}).
...
The density-pressure relationship is described by the third-order Birch-Murnaghan equation of state:
...
We used EoS parameters from \citeA{tange_pvt_2012} for MgSiO$_3$ bridgmanite, \citeA{saxena_thermodynamics_2015} for Fe metal, \citeA{lai_thermal_2023} for H$_2$O (ice VII), and \citeA{dorogokupets_equations_2007} for MgO\@. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Synthesis of the samples (move later to SI)}
...
\caption{Synthesis pressure and temperature conditions of the samples (Table\,\ref{tab:runtable}). 
%\begin{cbox}
...
For the phase assignment, for example, at 1~bar after decompression, twelve Bragg reflections are resolved between 4 and 20 $2\theta$ degrees (Fig.~\ref{fig:gsas-V}). 
All reflections are indexed well to cubic Mg$_2$FeH$_6$ with the double-perovskite structure (space group $Fm\overline{3}m$) \cite{didisheim_dimagnesium_1984, retuerto_highpressure_2010}. \linelabel{line:end:Mg2FeH6-index}
...
Each heated area was subjected to five heating events with each event with 4 heating-cooling cycle. \sidecomment{This sounds wrong to me.  During pulse heating there are over 10,000 heating-cooling cycles within 0.1-1 second.}
...
\caption{The XRD patterns of Mg$_2$FeH$_6$ and MgH$_2$ collected at 300~K after synthesis at higher temperatures. (a) This sample is synthesized at 3206~K and 34~{GPa}. (b) This sample was synthesized at 2460~K and 25~{GPa} in an Ar + H$_2$ medium (run M\_D1). 
Vertical ticks indicate the expected peak positions of the identified phases, with thick ticks highlighting Mg$_2$FeH$_6$ and MgH$_2$. Minor MgO is present due to the starting material oxidation during sample loading at room conditions.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Result (EOS, this one will be used for result section in the main article)}

\subsection{Synthesis of starting materials}
...
The Mg$_2$FeH$_6$ samples were synthesized at XXX--XXX GPa and XXXX--XXXX~K\@.
...
For the MgH$_2$ samples, ... write similar paragraph here.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Stability of Mg$_2$FeH$_6$ Perovskite and MgH$_2$ at High Pressures}
...
While we attempted to expand the pressure coverage of synthesis and experiments, they were very difficult because of mechanical instability of diamond anvils induced by hydrogen when laser heating to temperatures over 2000~K are involved.
...
In contrast, the high-pressure $\varepsilon$ phase, dominant at pressures above 14~GPa, we obtained $V_0=102.7{\pm}1.0$~Å$^3$ and $K_0=54{\pm}3$~GPa, with fixing $K_0'$ to 4 (Fig.~\ref{fig:mgh2-eos}). 
The intermediate $\beta$ and $\delta$ phases remain insufficiently constrained due to limited pressure stability, precluding meaningful EoS fitting. 
...
The measured $P$–$V$ relation agrees with the EoS from the DFT study \cite{cui_structural_2008}.
...
Some other sub-Neptunes may incorporate substantial water as an envelope on top of the silicate-metal interior, forming waterworlds \cite{luque_density_2022, tsiaras_water_2019, benneke_water_2019, burn_radius_2024, venturini_nature_2020}.
...
However, the melting temperature of Mg$_2$FeH$_6$ is not yet well constrained and may be molten below the hot interface temperatures predicted for young or massive sub-Neptunes ($>$2000 K) \cite{kite_atmosphere_2020}. 
Therefore, crystalline Mg$_2$FeH$_6$ is most likely to be stable in cooler sub-Neptunes or in later evolutionary stages after interior crystallization, where it could act as a robust solid-phase sink for hydrogen at the base of the H$_2$ envelope \cite{kim_stability_2023}. 
It is also important to note that the density difference between solid and melt reduces with pressure \addcite.  
Therefore, the EoS of Mg$_2$FeH$_6$ presented here can be used as a first-order approximation for the molten hydride interior as well.
...
\caption{
Mass-radius relations of planetary materials and settings. 
Gray circles denote observed exoplanets for reference. \cboxinline{this is now missing.  Add them back to b,c,d.}
(a) Comparison of single materials. 
Curves are shown for Fe metal (brown), MgSiO$_3$ bridgmanite (brd; black, \citeA{tange_pvt_2012}), Mg$_2$FeH$_6$ (red; this study), MgH$_2$ (purple; this study), and H$_2$O (blue, \citeA{zeng_growth_2019}). Mg$_2$FeH$_6$ is less dense than brd while more dense than H$_2$O.  MgH$_2$ almost completely overlaps H$_2$O.
(b) Comparison with commonly adopted waterworld sub-Neptune models: 2MgO + Fe (black), 2Brd + Fe (gray), Mg$_2$FeH$_6$ (red), Brd + 25~wt\% H$_2$O (cyan), and Brd + 50~wt\% H$_2$O (green). 
The Mg$_2$FeH$_6$ curve overlaps models with H$_2$O envelopes despite containing no H$_2$O. 
...
(c) Comparison with commonly adopted gas-dwarf models. 
The Mg$_2$FeH$_6$ + 25~wt\% H$_2$O model (purple) and the 2MgO + Fe + H$_2$ models (gray) are for comparing effects of element exchange between the interior and envelope in a closed system. 
The Brd + 50~wt\% H$_2$O model (green) and pure Mg$_2$FeH$_6$ (red) are shown for comparison.
(d) Comparison between an undifferentiated hydride planet and differentiated hydride planets. We assumed that hydrogen not included in the structure of Mg$_2$FeH$_6$ exists in the envelope. 
...
It is also notable that the mass-radius relation of MgH$_2$ overlaps that of H$_2$O almost completely.
...
Si was not included in our experiments and therefore more comparable mineral phase is MgO.
...
Therefore, changing from brd to MgO does not make significant difference in making comparison with rocky mass-radius relations.
In terms of cation composition, 2MgO + Fe can make a good comparison with Mg$_2$FeH$_6$.
The comparison can also reveal the impact of replacing O with H, or change in mineralogy from oxides (or silicates) to hydrides.
...
Also, the comparison can be viewed as differentiated rocky (2MgO + Fe) versus undifferentiated hydride (both Mg and Fe in hydride).
Fig.~\ref{fig:M-R}b shows that waterworlds cannot be distinguished from hydrogen ingassed planets with little atmosphere, adding important previously unknown degeneracy in the analysis.

Despite the fact that atomic size of oxygen are much greater than that of hydrogen, radius of Mg$_2$FeH$_6$ planet is greater in radius than that of 2MgO + Fe by $\sim$20\% for given mass.  
...
Also Mg is in ionic state in Mg$_2$FeH$_6$.
In fact, our 2MgO + Fe mass-radius model was calculated for a two-layer differentiated model (Fe metal near the center of the core and MgO in the outer layer). 
Stability and formation of Mg$_2$FeH$_6$ from MgO liquid and Fe metal liquid under hydrogen-rich conditions \cite{kim_stability_2023} suggest that under reducing conditions a significant amount of Fe could well be contained in hydrides rather than forming a separate metallic layer near the center of the planet, potentially resulting in ``coreless'' planet configuration.
...
The stability of Mg$_2$FeH$_6$ hydride suggests that such coreless configuration could be also possible under reducing conditions through formation of hydrides.

% left over but should be added above.
The 2MgO + Fe + 5H$_2$ (or 7~wt\% H$_2$) model can be regarded as gas dwarf without any hydrogen ingassing to the interior.
...
We first compare cases where amount of elements are preserved: (1) 2MgO + Fe + 5H$_2$ (or 7~wt\% H$_2$) versus (2) Mg$_2$FeH$_6$ + 2H$_2$O (or 25~wt\% H$_2$O).
...
We found that severe ingassing of hydrogen can reduce the radius by XX-XX\% (Fig.~\ref{fig:M-R}c), making a hydrogen-rich planet looking very similar to waterworlds in mass-radius space.

These models are introduced here only to compare how redistribution of elements can change the mass-radius relations without considering chemical compatibility of the materials in the models: particularly between H$_2$O and Mg$_2$FeH$_6$.
In addition, recent experiments have shown that 2MgO + Fe core unlikely remains unreacted with hydrogen envelope \cite{kim_stability_2023}.
  
%However, it is also possible that such \sidecomment{this sentence is incomplete.}
We should note that the combination of the materials we use here is only to estimate the effect of H$_2$ ingassing.
...
MgH$_2$ also exhibits low density, even lower than Mg$_2$FeH$_6$ and matches that of H$_2$O (Fig.~\ref{fig:M-R}a). 
...
This indicates that the reduction in density associated with hydrogen incorporation is not unique to Mg$_2$FeH$_6$, but is likely a general feature of hydrides. 
...
Icy cores form beyond the snow line through the accretion of ice‑rich pebbles, as expected in core‑accretion and pebble‑accretion models of sub‑Neptune formation \cite{bitsch_dry_2021, bean_nature_2021, burn_radius_2024, venturini_nature_2020}. 
These cores can incorporate a substantial fraction of water ice, leading to interiors that are less dense than purely rocky material at the same mass, and thereby helping to increase the planet's radius without requiring an extremely massive H/He envelope \cite{zeng_growth_2019}. 
...
Figure\,\ref{fig:M-R}d shows that planets composed of Mg$_2$FeH$_6$ are substantially more compact than planets containing the same Mg--Fe--H components partitioned into MgH$_2$, Fe (or FeH), and hydrogen-rich envelope.
...
Consequently, how much hydrogen can be consumed to form hydride for the interior could strongly modify planetary radii while preserving nearly the same bulk Mg--Fe--H composition.
Such redistribution of hydrogen between interior and envelope provides a potential mechanism for generating substantial diversity in observed sub-Neptune radii without requiring large differences in total hydrogen abundance.
...
Future high-pressure experiments and ab initio calculations are needed to map the phase boundaries and evaluate the hydrogen storage capacity of Fe-Mg hydrides under sub-Neptune conditions.
\begin{cbox}
