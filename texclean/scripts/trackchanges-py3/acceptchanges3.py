...
from AcceptChanges3.consoleoutput import ConsoleControlledOutput
...
# added by Dan Shim to skip all the parts before begin document
def beginDocument(line, output, startpos):
	match = line[startpos:].find('begin{document}')
	if match == -1:
		return False
	else:
...
# =====================================================================
def labelText(infile, output, options):
...
if __name__ == "__main__":
	...
	labelText(infile,output, options)
	if DEBUG:
